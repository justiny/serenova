    ...
    $.fn.extend({
        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                /* -------- LOAD IFRAME -------- */
                function loadIframe(){
                    content.html('<iframe class="venoframe" src="'+dest+'"></iframe><br/><br/><a href="https://www.serenova.com/request-a-demo/" class="button button-blue button-medium xs-mb-25 md-mb-0 md-mr-40">See It In Action</a>');
