...
class SiteOptions
{
  ...
  function register() {
    add_action( 'after_setup_theme', array( $this, 'es_acf_site_options' ) );
    add_filter( 'timber_context', array( $this, 'es_acf_options' ) );
  }

  // Makes all ACF Options available throughout site
  function es_acf_options( $context ) {
    if( class_exists('acf') ) :
  ...
  // Customize the site options tab in admin
  function es_acf_site_options () {
