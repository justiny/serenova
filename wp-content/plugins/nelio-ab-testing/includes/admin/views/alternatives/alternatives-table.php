	...
	abstract class NelioABAlternativesTable extends NelioABAdminTable {
		...
		function __construct( $items ){
			parent::__construct( array(
				'singular'  => __( 'alternative', 'nelio-ab-testing' ),
				'plural'    => __( 'alternatives', 'nelio-ab-testing' ),
				'ajax'      => false
			)	);
		...
		public function inline_edit_form() { ?>
			<fieldset class="inline-edit-col-left">
				<div class="inline-edit-col">
					<h4><?php echo esc_html( $this->get_inline_edit_title() ); ?></h4>
					<label>
						<span class="title"><?php echo esc_html( $this->get_inline_name_field_label() ); ?> </span>
		...
		protected function get_default_description_for_new_alternative() {
			return sprintf( '%s <small><a href="%s" target="_blank">%s</a></small>',
				esc_html__( 'Set a descriptive name for the alternative.', 'nelio-ab-testing' ),
				esc_url( 'http://support.nelioabtesting.com/support/solutions/articles/1000129198' ),
				esc_html__( 'Help', 'nelio-ab-testing' ) );
		}
		...
		public function print_new_alt_form() { ?>
			<tr class="new-alt-form inline-edit-row inline-edit-row-page inline-edit-page quick-edit-row quick-edit-row-page inline-edit-page alternate" style="display:none;">
				<td colspan="<?php echo esc_attr( $this->get_column_count() ); ?>" class="colspanchange">
					...
					<fieldset class="inline-edit-col-left">
						<div class="inline-edit-col">
							<h4><?php esc_html_e( 'New Alternative Creation', 'nelio-ab-testing' ); ?></h4>
							<label>
								<span class="title"><?php echo esc_html( $this->get_inline_name_field_label() ); ?> </span>
								<span class="input-text-wrap">
									<input type="text" id="new_alt_name" name="new_alt_name" class="ptitle" value="" style="width:300px;" maxlength="200" />
									<p class="description" style="display:block;"><?php
		...
		public function inline_save_button_label() {
			return __( 'Update', 'nelio-ab-testing' );
		}
