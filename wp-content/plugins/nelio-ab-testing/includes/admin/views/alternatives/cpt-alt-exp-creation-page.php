...
if ( !class_exists( 'NelioABCptAltExpCreationPage' ) ) {

	require_once( NELIOAB_ADMIN_DIR . '/views/alternatives/cpt-alt-exp-edition-page.php' );
	class NelioABCptAltExpCreationPage extends NelioABCptAltExpEditionPage {

		public function __construct( $title, $alt_type ) {
			parent::__construct( $title, $alt_type );
			$this->set_icon( 'icon-nelioab' );
			$this->set_form_name( 'nelioab_new_ab_cpt_exp_form' );
		}
