...
if ( !class_exists( 'NelioABCssAltExpEditionPage' ) ) {
		...
		protected function print_alternatives() { ?>
			<h2><?php
				...
				printf( '<a onClick="%1$s" class="add-new-h2" href="#">%2$s</a>',
					...
					__( 'New Alternative CSS', 'nelio-ab-testing' )
				);
	...
	class NelioABCssAlternativesTable extends NelioABAlternativesTable {
		...
		public function extra_tablenav( $which ) {
			if ( 'top' == $which ){
				_e( 'Please, <b>add one or more</b> CSS fragments as alternatives.', 'nelio-ab-testing' );
			}
		}
		...
		public function display_rows_or_placeholder() {
			...
			$title = __( 'Original: Default CSS without any additions', 'nelio-ab-testing' );
			$expl = __( 'This original version of this experiment is not using any alternative CSS at all.', 'nelio-ab-testing' );
			?>
			<tr><td>
