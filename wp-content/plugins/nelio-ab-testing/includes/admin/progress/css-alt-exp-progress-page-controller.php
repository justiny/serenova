...
if ( !class_exists( 'NelioABCssAltExpProgressPageController' ) ) {

	require_once( NELIOAB_MODELS_DIR . '/experiment.php' );
	require_once( NELIOAB_MODELS_DIR . '/experiments-manager.php' );

	require_once( NELIOAB_ADMIN_DIR . '/views/progress/css-alt-exp-progress-page.php' );
	require_once( NELIOAB_ADMIN_DIR . '/progress/alt-exp-progress-super-controller.php' );

	class NelioABCssAltExpProgressPageController extends NelioABAltExpProgressSuperController {
		...
		public static function build() {
			...
			$view  = new NelioABCssAltExpProgressPage( $title );
		...
		public function apply_alternative() {
			// Nothing to be done in here, because there is nowhere
			// to save the winning CSS... The user has to make it
			// manually
		}

	}//NelioABCssAltExpProgressPageController

}

$aux = new NelioABCssAltExpProgressPageController();
$aux->manage_actions();
