...
if ( !class_exists( 'NelioABMultisiteSettingsPageController' ) ) {
	...
	class NelioABMultisiteSettingsPageController {
		...
		public static function build() {
			$title = __( 'Network Admin Settings', 'nelio-ab-testing' );
		...
		public function save_settings() {
			...
			$plugin_availability = false;
			if ( isset( $_POST['plugin_available_to'] ) ) {
				$plugin_availability = sanitize_text_field( $_POST['plugin_available_to'] );
			}//end if
			$enabled_for_everybody = $plugin_availability == NelioABSettings::PLUGIN_AVAILABLE_TO_ANY_ADMIN;
