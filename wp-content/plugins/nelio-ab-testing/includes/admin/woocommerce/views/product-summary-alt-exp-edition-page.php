...
if ( !class_exists( 'NelioABProductSummaryAltExpEditionPage' ) ) {
	...
	class NelioABProductSummaryAltExpEditionPage extends NelioABAltExpPage {
		...
		protected function get_basic_info_elements() {
			return array(
				...
				array (
					'label'     => esc_html__( 'Original Product', 'nelio-ab-testing' ),
					'id'        => 'exp_original',
		...
		protected function print_ori_field() {
			...
			<span class="description" style="display:block;"><?php
				esc_html_e( 'You will create alternative summaries (name, featured image, and description) for this product.', 'nelio-ab-testing' );
			?></span><?php
		}
		...
		protected function print_alternatives() { ?>
			<h2><?php
				printf( '<a onClick="javascript:%1$s" class="add-new-h2" href="javascript:;">%2$s</a>',
					...
					esc_html( __( 'New Product Summary', 'nelio-ab-testing' ) )
				);
			?></h2><?php
	...
	class NelioABProductSummaryAlternativesTable extends NelioABAlternativesTable {
		...
		public function get_columns(){
			return array(
				'headline_image' => '',
				'name'  => __( 'Product Summaries', 'nelio-ab-testing' ),
			);
		}
		...
		public function extra_tablenav( $which ) {
			if ( 'top' == $which ){
				_e( 'Please, <b>add one or more</b> alternative product summaries.', 'nelio-ab-testing' );
			}
		}
		...
		public function display_rows_or_placeholder() {
			...
			$title = __( 'Original Product Summary', 'nelio-ab-testing' );
			$expl = __( 'Your current Product Summary, defined as a combination of a name, a featured image, and a (short) description.', 'nelio-ab-testing' );
			?>
			<tr><td>
		...
		public function print_new_alt_form() { ?>
			<tr class="new-alt-form inline-edit-row inline-edit-row-page inline-edit-page quick-edit-row quick-edit-row-page inline-edit-page alternate" style="display:none;">
				<td colspan="<?php echo esc_attr( $this->get_column_count() ); ?>" class="colspanchange">
					<?php $this->print_form_for_editing_a_headline( __( 'New Alternative Product Summary', 'nelio-ab-testing' ) ); ?>
		...
		protected function print_inline_edit_form() { ?>
			<tr class="nelioab-quick-edit-row inline-edit-row inline-edit-row-page inline-edit-page quick-edit-row quick-edit-row-page inline-edit-page" style="display:none;">
				<td colspan="<?php echo esc_attr( $this->get_column_count() ); ?>" class="colspanchange">
					<?php $this->print_form_for_editing_a_headline( __( 'Edit Product Summary', 'nelio-ab-testing' ) ); ?>
					<p class="submit inline-edit-save">
					...
					<div style="width:60%;display:inline-block;vertical-align:top;">
						<span class="input-text-wrap">
							<div class="nelio-sect"><label style="margin:0px;">
								<input type="text" class="headline_title ptitle" value="" placeholder="<?php echo esc_attr( __( 'Title', 'nelio-ab-testing' ) ); ?>" />
							</label></div>
							<textarea class="headline_excerpt" placeholder="<?php echo esc_attr( __( 'Original Description', 'nelio-ab-testing' ) ); ?>"></textarea>
						</span>
					</div>
				</div>
			</fieldset>
