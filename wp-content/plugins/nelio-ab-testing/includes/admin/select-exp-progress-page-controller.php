	...
	class NelioABSelectExpProgressPageController {
		...
		public static function attempt_to_load_proper_controller() {
			...
			if ( isset( $_POST['nelioab_exp_type'] ) ) {
				return NelioABSelectExpProgressPageController::get_controller( absint( $_POST['nelioab_exp_type'] ) );
			}//end if

			if ( isset( $_GET['actual_exp_type'] ) && isset( $_GET['forcestop'] ) ) {
				return NelioABSelectExpProgressPageController::get_controller( absint( $_GET['actual_exp_type'] ) );
			}//end if

			if ( isset( $_GET['exp_type'] ) && isset( $_GET['forcestop'] ) ) {
				return NelioABSelectExpProgressPageController::get_controller( absint( $_GET['exp_type'] ) );
			}//end if
		...
		public static function build() {
			...
			if ( $controller != NULL ) {
				...
				if ( isset( $_GET['id'] ) ) {
					...
					$view->keep_request_param( 'id', absint( $_GET['id'] ) );
				}//end if
