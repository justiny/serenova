		...
		public static function to_string( $err ) {
			switch( $err ) {
				...
				case NelioABErrCodes::INVALID_PRODUCT_REG_NUM:
					return __( 'Invalid product registration number.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_SITE:
					return __( 'Invalid site.', 'nelio-ab-testing' );
				case NelioABErrCodes::SITE_IS_NOT_ACTIVE:
					return __( 'This site is not active.', 'nelio-ab-testing' );
				case NelioABErrCodes::MAX_SITES:
					return __( 'This account has reached the maximum allowed number of active sites.', 'nelio-ab-testing' );
				case NelioABErrCodes::NO_MORE_QUOTA:
					return __( 'There is no more quota available.', 'nelio-ab-testing' );
				case NelioABErrCodes::UNPAID_SUBSCRIPTION:
					return __( 'Subscription has not been paid yet.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_MAIL:
					return __( 'Invalid e-mail.', 'nelio-ab-testing' );
				case NelioABErrCodes::SEVERAL_CUSTOMERS_WITH_SAME_MAIL:
					return __( 'This e-mail is already registered.', 'nelio-ab-testing' );
				case NelioABErrCodes::TOO_FEW_PARAMETERS:
					return __( 'Too few parameters.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_SITE_URL:
					return __( 'The URL of the site is invalid.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_PARAMETERS:
					return __( 'Invalid parameters.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_EXPERIMENT:
					return __( 'Invalid experiment.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_ALTERNATIVE:
					return __( 'Invalid alternative.', 'nelio-ab-testing' );
				case NelioABErrCodes::RESULTS_NOT_AVAILABLE_YET:
					return __( 'Results for this experiment are not yet available.', 'nelio-ab-testing' );
				case NelioABErrCodes::DEACTIVATED_USER:
					return __( 'User account has been deactivated.', 'nelio-ab-testing' );
				case NelioABErrCodes::EXPERIMENT_ID_NOT_FOUND:
					return __( 'Experiment not found.', 'nelio-ab-testing' ) . '<br />' .
						'<small><a href="'. admin_url( 'admin.php?page=nelioab-experiments' ) . '">' .
						__( 'Go to my list of experiments...', 'nelio-ab-testing' ) .
						'</a></small>';
				case NelioABErrCodes::INVALID_GOAL:
					return __( 'Goal not found.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_MODIFICATION:
					return __( 'The experiment cannot be modified.', 'nelio-ab-testing' );
				case NelioABErrCodes::EXPERIMENT_NOT_RUNNING:
					return __( 'The experiment is not running.', 'nelio-ab-testing' );
				case NelioABErrCodes::FEATURE_NOT_AVAILABLE_FOR_CUSTOMER:
					return __( 'The feature you are trying to use is not available.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_SCHEDULE_DATE:
					return __( 'The experiment cannot be scheduled for the given date.', 'nelio-ab-testing' );
				case NelioABErrCodes::EXPERIMENT_CANNOT_BE_DUPLICATED:
					return __( 'The experiment cannot be duplicated.', 'nelio-ab-testing' );
				case NelioABErrCodes::INCOMPLETE_EXPERIMENT:
					return __( 'The experiment cannot be started: missing information (for instance, an alternative or a set of actions in a goal).', 'nelio-ab-testing' );
				...
				case NelioABErrCodes::MULTI_PAGE_GOAL_NOT_ALLOWED_IN_BASIC:
					return sprintf(
						__( 'Oops! The experiment cannot be started because it defines more than one goal page. Please, modify your experiment so that it includes one goal page only or <a href="%s">upgrade your Nelio A/B Testing subscription package</a>.', 'nelio-ab-testing' ),
						esc_url( 'https://neliosoftware.com/testing/contact/?plugin=mge-basic' ) );

				case NelioABErrCodes::HEATMAP_NOT_ALLOWED_IN_BASIC:
					return sprintf(
						__( 'Oops! Your current subscription plan does not permit you to use Heatmap Experiments. Please, consider <a href="%s">upgrading your Nelio A/B subscription package</a>.', 'nelio-ab-testing' ),
						esc_url( 'https://neliosoftware.com/testing/contact/?plugin=hme-basic' ) );



				// Private errors
				case NelioABErrCodes::BACKEND_NOT_AVAILABLE:
					return __( 'Backend is not available.', 'nelio-ab-testing' );
				case NelioABErrCodes::BACKEND_NO_SITE_CONFIGURED:
					return __( 'No site has been configured.', 'nelio-ab-testing' );
				case NelioABErrCodes::ERROR_404:
					return __( 'Error 404 when accessing an endpoint.', 'nelio-ab-testing' );
				case NelioABErrCodes::NON_ACCEPTED_TAC:
					return __( 'Terms and conditions are not accepted.', 'nelio-ab-testing' );
				case NelioABErrCodes::STATUS_204:
					return __( 'Backend is not accessible.<br />Please, try again in just a few moments.', 'nelio-ab-testing' );
				case NelioABErrCodes::NO_HEATMAPS_AVAILABLE:
					return __( 'Be patient... We are still collecting the data for your heatmaps and clickmaps.', 'nelio-ab-testing' );
				case NelioABErrCodes::NO_HEATMAPS_AVAILABLE_FOR_NON_RUNNING_EXPERIMENT:
					return __( 'We did not collect enough data for building your heatmaps and clickmaps. Sorry.', 'nelio-ab-testing' );
				case NelioABErrCodes::UNKNOWN_ERROR:
					return __( 'An unknown error has occurred.', 'nelio-ab-testing' );
				case NelioABErrCodes::EXPERIMENT_CANNOT_BE_STARTED:
					return __( 'Experiment cannot be started.', 'nelio-ab-testing' );
				case NelioABErrCodes::INVALID_NONCE:
					return __( 'Invalid «_nonce». Are you sure you want to do this?', 'nelio-ab-testing' );
				case NelioABErrCodes::YOU_DONT_HAVE_PERMISSION:
					return __( 'You don\'t have permission to perform this action.', 'nelio-ab-testing' );
				case NelioABErrCodes::BACKEND_UNKNOWN_ERROR:
				default:
					return __( 'An unknown error occurred while accessing the backend.', 'nelio-ab-testing' );
			}
		}
